 ...
 * @category Layout
 */
export var LayoutTrigger = /*#__PURE__*/function (_Trigger) {
  /**
    ...
    value: function register() {
      registerTrigger("layout", function (element, args, actions, config) {
        return new LayoutTrigger(element, actions, MH.assign(config, {
          layout: validateStringRequired("layout", MH.strReplace(MH.strReplace(args[0] || "", /(min|max)-/g, "$1 "), /-to-/g, " to "), function (value) {
