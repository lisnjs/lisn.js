 ...
 */
var NextPage = exports.NextPage = /*#__PURE__*/function () {
  ...
  return _createClass(NextPage, null, [{
    ...
    value: function register() {
      (0, _action.registerAction)("next-page", function (element) {
 ...
 * @category Controlling pagers
 */
var PrevPage = exports.PrevPage = /*#__PURE__*/function () {
  ...
  return _createClass(PrevPage, null, [{
    key: "register",
    value: function register() {
      (0, _action.registerAction)("prev-page", function (element) {
 ...
 * @category Controlling pagers
 */
var GoToPage = exports.GoToPage = /*#__PURE__*/function () {
  ...
  return _createClass(GoToPage, null, [{
    key: "register",
    value: function register() {
      (0, _action.registerAction)("go-to-page", function (element, args) {
        return new GoToPage(element, (0, _math.toInt)(args[0]));
      });
    }
  }]);
}();
 ...
 * @category Controlling pagers
 */
var EnablePage = exports.EnablePage = /*#__PURE__*/function () {
  ...
  return _createClass(EnablePage, null, [{
    key: "register",
    value: function register() {
      (0, _action.registerAction)("enable-page", function (element, args) {
        return new EnablePage(element, (0, _math.toInt)(args[0]));
      });
    }
  }]);
}();
 ...
 * @category Controlling pagers
 */
var DisablePage = exports.DisablePage = /*#__PURE__*/function () {
  ...
  return _createClass(DisablePage, null, [{
    key: "register",
    value: function register() {
      (0, _action.registerAction)("disable-page", function (element, args) {
        return new DisablePage(element, (0, _math.toInt)(args[0]));
      });
    }
  }]);
}(); // --------------------
var getMethods = function getMethods(element) {
  ...
  var goToPage = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(widget, pageNum, altPageNum) {
  ...
  var widgetPromise = (0, _widget.fetchUniqueWidget)("pager", element, _pager.Pager);
  return {
