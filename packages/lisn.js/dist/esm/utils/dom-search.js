 ...
 */
export const getReferenceElement = (spec, thisElement) => {
  if (!spec) {
    return thisElement;
  }
  if (spec[0] === "#") {
 ...
 * @category DOM: Searching for reference elements
 */
export const waitForReferenceElement = (spec, thisElement, timeout = 200) => waitForElement(() => getReferenceElement(spec, thisElement), timeout);
