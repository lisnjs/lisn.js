 ...
 * @category Overlays
 */
export var getOverlay = function getOverlay(userOptions) {
  var _overlays$get;
 ...
 * @category Overlays
 */
export var createOverlay = /*#__PURE__*/function () {
...
var tryGetParent = function tryGetParent(userSuppliedParent, position) {
  return userSuppliedParent !== null && userSuppliedParent !== void 0 ? userSuppliedParent : position === MC.S_FIXED ? MH.getBody() : tryGetMainContentElement();
};
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 7;
          return waitForElement(MH.getBody);
        case 7:
