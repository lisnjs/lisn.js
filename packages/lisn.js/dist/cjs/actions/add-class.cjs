 ...
 */
var AddClass = exports.AddClass = /*#__PURE__*/function () {
  function AddClass(element) {
    ...
    var _getMethods = getMethods(element, classNames),
  ...
  return _createClass(AddClass, null, [{
    ...
    value: function register() {
      (0, _action.registerAction)("add-class", function (element, classNames) {
 ...
 * @category Adding/removing class
 */
var RemoveClass = exports.RemoveClass = /*#__PURE__*/function () {
  function RemoveClass(element) {
    ...
    var _getMethods2 = getMethods(element, classNames),
  ...
  return _createClass(RemoveClass, null, [{
    key: "register",
    value: function register() {
      (0, _action.registerAction)("remove-class", function (element, classNames) {
        return _construct(RemoveClass, [element].concat(_toConsumableArray(classNames)));
      });
    }
  }]);
}(); // --------------------
var getMethods = function getMethods(element, classNames) {
  return {
    _add: function _add() {
      return _cssAlter.addClasses.apply(void 0, [element].concat(_toConsumableArray(classNames)));
    },
    _remove: function _remove() {
      return _cssAlter.removeClasses.apply(void 0, [element].concat(_toConsumableArray(classNames)));
    },
    _toggle: function () {
      var _toggle2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              cls = _step.value;
              _context.next = 7;
              return (0, _cssAlter.toggleClass)(element, cls);
            case 7:
              _context.next = 3;
              break;
            case 9:
