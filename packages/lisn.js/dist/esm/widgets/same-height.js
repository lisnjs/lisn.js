 ...
 * ```
 */
export var SameHeight = /*#__PURE__*/function (_Widget) {
  function SameHeight(containerElement, config) {
    ...
    _this.toColumn = function () {
      return setData(containerElement, MC.PREFIX_ORIENTATION, MC.S_VERTICAL);
    };
    _this.toRow = function () {
      return delData(containerElement, MC.PREFIX_ORIENTATION);
    };
    ...
    value: function register() {
      registerWidget(WIDGET_NAME, function (element, config) {
        if (MH.isHTMLElement(element)) {
          ...
          logError(MH.usageError("Only HTMLElement is supported for SameHeight widget"));
        }
        return null;
      }, configValidator);
    }
...
}, MC.S_DEBOUNCE_WINDOW, validateNumber), "minGap", validateNumber), "maxFreeR", validateNumber), "maxWidthR", validateNumber);
var isText = function isText(element) {
  return getData(element, PREFIX_ITEM__FOR_SELECT) === S_TEXT || getData(element, PREFIX_ITEM__FOR_SELECT) !== S_IMAGE && MH.isHTMLElement(element) && MH.lengthOf(element.innerText) >= MIN_CHARS_FOR_TEXT;
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          minGap = getNumValue(MH.strReplace(colGapStr, /px$/, ""), settings.sameHeightMinGap);
...
var findItems = function findItems(containerElement) {
  var items = _toConsumableArray(MH.querySelectorAll(containerElement, getDefaultWidgetSelector(PREFIX_ITEM__FOR_SELECT)));
...
var init = function init(widget, containerElement, items, config) {
  ...
  var sizeWatcher = SizeWatcher.reuse(_defineProperty(_defineProperty({}, MC.S_DEBOUNCE_WINDOW, debounceWindow), "resizeThreshold", config._resizeThreshold));
  ...
  widget.onDestroy(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          _context2.next = 10;
          return removeClasses(element, PREFIX_ITEM);
        case 10:
          _context2.next = 3;
          break;
        case 12:
        ...
        case 20:
          allItems.clear();
          _context2.next = 23;
          return removeClasses(containerElement, PREFIX_ROOT);
        case 23:
        case "end":
...
var getOptimalHeight = function getOptimalHeight(measurements, config, logger) {
  ...
  logError(MH.bugError("Invalid SameHeight calculations"), measurements, config);
  return NaN; // sanity checks failed
};
//# sourceMappingURL=same-height.js.map