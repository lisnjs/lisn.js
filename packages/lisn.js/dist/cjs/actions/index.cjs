...
var _addClass = require("./add-class.cjs");
Object.keys(_addClass).forEach(function (key) {
...
var _animate = require("./animate.cjs");
...
var _animatePlay = require("./animate-play.cjs");
Object.keys(_animatePlay).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
...
var _scrollTo = require("./scroll-to.cjs");
...
var _setAttribute = require("./set-attribute.cjs");
Object.keys(_setAttribute).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
