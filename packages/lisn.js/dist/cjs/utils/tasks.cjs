 ...
 * @category Tasks
 */
var scheduleHighPriorityTask = exports.scheduleHighPriorityTask = function scheduleHighPriorityTask(task) {
 ...
 * @category Tasks
 */
var getDebouncedHandler = exports.getDebouncedHandler = function getDebouncedHandler(debounceWindow, handler) {
  if (!debounceWindow) {
    return handler;
  }
  var timer = null;
  ...
  return function () {
    ...
    lastArgs = args;
    if (timer === null) {
      timer = MH.setTimer(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
 ...
 * @category Tasks
 */
var waitForDelay = exports.waitForDelay = function waitForDelay(delay) {
