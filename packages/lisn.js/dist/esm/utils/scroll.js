 ...
 * @category Scrolling
 */
export { _isScrollable as isScrollable };
export var getClosestScrollable = function getClosestScrollable(element, options) {
 ...
 * @category Scrolling
 */
export var getCurrentScrollAction = function getCurrentScrollAction(scrollable) {
 ...
 * @category Scrolling
 */
export var scrollTo = function scrollTo(to, userOptions) {
 ...
 * @category Validation
 */
export var isValidScrollDirection = function isValidScrollDirection(direction) {
  return MH.includes(SCROLL_DIRECTIONS, direction);
};
 ...
 * @category Validation
 */
export var isValidScrollDirectionList = function isValidScrollDirectionList(directions) {
 ...
 * @internal
 */
export var mapScrollable = function mapScrollable(original, actualScrollable) {
 ...
 * @internal
 */
export var unmapScrollable = function unmapScrollable(original) {
 ...
 * @internal
 */
export var getClientWidthNow = function getClientWidthNow(element) {
 ...
 * @internal
 */
export var getClientHeightNow = function getClientHeightNow(element) {
 ...
 * @internal
 */
export var tryGetMainContentElement = function tryGetMainContentElement() {
 ...
 */
export var fetchMainContentElement = /*#__PURE__*/function () {
 ...
 * @internal
 */
export var tryGetMainScrollableElement = function tryGetMainScrollableElement() {
 ...
 * Exposed via ScrollWatcher
 */
export var fetchMainScrollableElement = /*#__PURE__*/function () {
 ...
 * @internal
 */
export var getDefaultScrollingElement = function getDefaultScrollingElement() {
  var body = MH.getBody();
 ...
 * @internal
 */
export var tryGetScrollableElement = function tryGetScrollableElement(target) {
 ...
 * @internal
 */
export var fetchScrollableElement = /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 12:
                    ...
                    progress = easeInOutQuad(MH.min(1, elapsed / duration));
                    currentPosition = {
...
var getBorderWidth = function getBorderWidth(element, side) {
  return MH.ceil(MH.parseFloat(getComputedStylePropNow(element, "border-".concat(side))));
};
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            if (!contentElement) {
              logError(MH.usageError("No match for '".concat(mainScrollableElementSelector, "'. ") + "Scroll tracking/capturing may not work as intended."));
