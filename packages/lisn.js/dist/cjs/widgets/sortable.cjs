 ...
 * ```
 */
var Sortable = exports.Sortable = /*#__PURE__*/function (_Widget) {
  /**
  ...
  function Sortable(element, config) {
    ...
    if (!MH.lengthOf(items)) {
      items.push.apply(items, _toConsumableArray(MH.querySelectorAll(element, (0, _widget.getDefaultWidgetSelector)(PREFIX_ITEM__FOR_SELECT))));
      if (!MH.lengthOf(items)) {
        items.push.apply(items, _toConsumableArray(MH.querySelectorAll(element, "[".concat(MC.S_DRAGGABLE, "]"))));
        if (!MH.lengthOf(items)) {
          items.push.apply(items, _toConsumableArray((0, _domQuery.getVisibleContentChildren)(element)));
        }
      }
    }
...
var isItemDraggable = function isItemDraggable(item) {
  return (0, _cssAlter.getBoolData)(item, PREFIX_IS_DRAGGABLE);
};
var init = function init(widget, element, items, methods) {
  ...
  var onDragStart = function onDragStart(event) {
    ...
    if (MH.isElement(currTarget) && isItemDraggable(currTarget) && MH.isMouseEvent(event)) {
      ...
      (0, _domOptimize.waitForMeasureTime)().then(function () {
    ...
    if (MH.isTouchEvent(event) && MH.lengthOf(event.touches) === 1) {
      ...
      if (parentEl && currentDraggedItem) {
        ...
        if (!floatingClone) {
          ...
          (0, _cssAlter.copyStyle)(currentDraggedItem, floatingClone, ["width", "height"]).then(function () {
            if (floatingClone) {
              (0, _domAlter.moveElement)(floatingClone, {
                to: parentEl
              });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          item = _step4.value;
          _context.next = 7;
          return (0, _cssAlter.removeClasses)(item, PREFIX_ITEM);
        case 7:
          _context.next = 9;
          return (0, _cssAlter.delData)(item, PREFIX_IS_DRAGGABLE);
        case 9:
          _context.next = 3;
          break;
        case 11:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.next = 7;
            return (0, _cssAlter.unsetBoolData)(items[itemNum - 1], PREFIX_IS_DRAGGABLE);
          case 7:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _context3.next = 7;
            return (0, _cssAlter.setBoolData)(items[itemNum - 1], PREFIX_IS_DRAGGABLE);
          case 7:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _domAlter.swapElements)(dragged, draggedOver, {
              ignoreMove: true
            });
          case 3:
            _context4.next = 7;
          ...
          case 5:
            _context4.next = 7;
            return (0, _domAlter.moveElement)(dragged, {
              to: draggedOver,
