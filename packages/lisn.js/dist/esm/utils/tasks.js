 ...
 * @category Tasks
 */
export var scheduleHighPriorityTask = function scheduleHighPriorityTask(task) {
 ...
 * @category Tasks
 */
export var getDebouncedHandler = function getDebouncedHandler(debounceWindow, handler) {
  if (!debounceWindow) {
    return handler;
  }
  var timer = null;
 ...
 * @category Tasks
 */
export var waitForDelay = function waitForDelay(delay) {
