...
import { maxAbs, havingMaxAbs, distanceBetween, areAntiParallel } from "./math.js";
 ...
 * @category Gestures
 */
export var getTouchGestureFragment = function getTouchGestureFragment(events, options) {
  ...
  if (numMoves === 2) {
    ...
    // treat it as zoom.
    if (!havingMaxAbs.apply(void 0, vectorA) ||
    // finger A still
    !havingMaxAbs.apply(void 0, vectorB) ||
    // finger B still
 ...
 * @category Gestures
 */
export var getTouchDiff = function getTouchDiff(events) {
