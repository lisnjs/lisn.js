 ...
 * ```
 */
var PageLoader = exports.PageLoader = /*#__PURE__*/function (_Widget) {
  function PageLoader(element, config) {
    ...
    (destroyPromise || MH.promiseResolve()).then(function () {
      ...
      var spinner = MH.createElement("div");
      ...
      if ((_config$autoRemove = config === null || config === void 0 ? void 0 : config.autoRemove) !== null && _config$autoRemove !== void 0 ? _config$autoRemove : true) {
        (0, _domEvents.waitForPageReady)().then(function () {
          return (0, _domAlter.hideAndRemoveElement)(element);
        }).then(_this.destroy);
      }
      _this.onDisable(function () {
        (0, _cssAlter.undisplayElement)(element);
        if (!MH.docQuerySelector(".".concat(PREFIX_ROOT))) {
          (0, _cssAlter.delHasModal)();
        }
      });
      _this.onEnable(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      _this.onDestroy(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  ...
  return _createClass(PageLoader, null, [{
    ...
    function get(element) {
      ...
      var instance = _superPropGet(PageLoader, "get", this, 2)([element, DUMMY_ID]);
    ...
    value: function enableMain(config) {
      var loader = MH.createElement("div");
