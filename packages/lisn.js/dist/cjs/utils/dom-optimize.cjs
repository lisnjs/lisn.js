 ...
 */
var waitForMutateTime = exports.waitForMutateTime = function waitForMutateTime() {
 ...
 * @category DOM: Preventing layout trashing
 */
var waitForMeasureTime = exports.waitForMeasureTime = function waitForMeasureTime() {
  return MH.newPromise(function (resolve) {
 ...
 * @category DOM: Preventing layout trashing
 */
var waitForSubsequentMutateTime = exports.waitForSubsequentMutateTime = function waitForSubsequentMutateTime() {
 ...
 * @category DOM: Preventing layout trashing
 */
var waitForSubsequentMeasureTime = exports.waitForSubsequentMeasureTime = function waitForSubsequentMeasureTime() {
...
var scheduleDOMTask = function scheduleDOMTask(queue, resolve) {
  ...
  if (!hasScheduledDOMTasks) {
    ...
    MH.onAnimationFrame(_runAllDOMTasks);
  }
};
var _runAllDOMTasks = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          (0, _tasks.scheduleHighPriorityTask)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  if (!MH.lengthOf(scheduledDOMMeasurements)) {
                    _context.next = 6;
                    break;
                  }
