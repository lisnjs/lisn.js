 ...
 * @category Logging
 */
export var LocalConsole = /*#__PURE__*/_createClass(function LocalConsole() {
...
var iOSlog = function iOSlog() {
  ...
  return MH.consoleInfo(joinAsString.apply(void 0, [" "].concat(args)));
};
...
var jestLog = {
  debug: function debug() {
    ...
    return MH.consoleDebug(joinAsString.apply(void 0, [" "].concat(args)));
  },
  log: function log() {
    for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }
    return MH.consoleLog(joinAsString.apply(void 0, [" "].concat(args)));
  },
  info: function info() {
  ...
  warn: function warn() {
    ...
    return MH.consoleWarn(joinAsString.apply(void 0, [" "].concat(args)));
  },
  error: function error() {
    for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
      args[_key6] = arguments[_key6];
    }
    return MH.consoleError(joinAsString.apply(void 0, [" "].concat(args)));
  }
};
