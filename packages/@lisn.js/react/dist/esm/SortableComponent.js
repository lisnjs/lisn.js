...
export const SortableComponent = _ref => {
  let {
      as,
      children,
      config,
  ...
  const elementRef = useWidget(newSortable, config, widgetRef);
  return createElement(as || "div", _objectSpread({
    ref: elementRef
  }, props), children);
};
export const SortableItemComponent = _ref2 => {
  let {
      as,
      children
    } = _ref2,
  ...
  return createElement(as || "div", _objectSpread({
    ["data-lisn-sortable-item"]: ""
  }, props), children);
};

// --------------------

const newSortable = (element, config) => new Sortable(element, Object.assign({}, config, {
