 ...
 * @category Logging
 */
export var RemoteConsole = /*#__PURE__*/function () {
  /**
  ...
  function RemoteConsole(url) {
    ...
    var cleanup = function cleanup() {
      ...
      tmpQueue = [];
      var instance = (_instances$get = instances.get(url)) === null || _instances$get === void 0 ? void 0 : _instances$get.get(connectTimeout);
      if (instance === _this) {
    ...
    _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ioClient = socket.io(url); // if not connected within connectTimeout initially, set as failed
            disconnectTimer = MH.setTimer(function () {
              hasFailed = true;
            }, connectTimeout);
  ...
  return _createClass(RemoteConsole, null, [{
    ...
    value: function reuse(url) {
      var _instances$get2;
      var connectTimeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_TIMEOUT;
      var rConsole = (_instances$get2 = instances.get(url)) === null || _instances$get2 === void 0 ? void 0 : _instances$get2.get(connectTimeout);
      if (!rConsole) {
