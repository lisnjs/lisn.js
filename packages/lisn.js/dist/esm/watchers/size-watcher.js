...
import { XResizeObserver } from "../modules/x-resize-observer.js";
 ...
 */
export var SizeWatcher = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 11:
              ...
              _context3.next = 18;
              return invokeCallback(wrapCallback(handler), element, sizeData);
            case 18:
            case "end":
...
var invokeCallback = function invokeCallback(callback, element, sizeData) {
  return callback.invoke(element, MH.copyObject(sizeData))["catch"](logError);
};
