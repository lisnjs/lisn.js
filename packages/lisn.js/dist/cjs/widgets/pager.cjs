...
var _gestureWatcher3 = require("../watchers/gesture-watcher.cjs");
var _scrollWatcher = require("../watchers/scroll-watcher.cjs");
var _viewWatcher3 = require("../watchers/view-watcher.cjs");
 ...
 * ```
 */
var Pager = exports.Pager = /*#__PURE__*/function (_Widget) {
  /**
  ...
  function Pager(element, config) {
    ...
    var pageSelector = (0, _widget.getDefaultWidgetSelector)(PREFIX_PAGE__FOR_SELECT);
    var toggleSelector = (0, _widget.getDefaultWidgetSelector)(PREFIX_TOGGLE__FOR_SELECT);
    var switchSelector = (0, _widget.getDefaultWidgetSelector)(PREFIX_SWITCH__FOR_SELECT);
    var nextSwitchSelector = (0, _widget.getDefaultWidgetSelector)(PREFIX_NEXT_SWITCH__FOR_SELECT);
    var prevSwitchSelector = (0, _widget.getDefaultWidgetSelector)(PREFIX_PREV_SWITCH__FOR_SELECT);
    if (!MH.lengthOf(pages)) {
      pages.push.apply(pages, _toConsumableArray(MH.querySelectorAll(element, pageSelector)));
      if (!MH.lengthOf(pages)) {
        pages.push.apply(pages, _toConsumableArray((0, _domQuery.getVisibleContentChildren)(element).filter(function (e) {
...
var setCurrentPage = function setCurrentPage(pagerEl, currPageNum, numPages, isPageDisabled) {
  ...
  (0, _cssAlter.setStyleProp)(pagerEl, VAR_CURRENT_PAGE, currPageNum + "");
  (0, _cssAlter.setData)(pagerEl, PREFIX_CURRENT_PAGE, currPageNum + "");
  (0, _cssAlter.setBoolData)(pagerEl, PREFIX_CURRENT_PAGE_IS_LAST, numPages === numPages);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 8;
          return (0, _cssAlter.setData)(el, PREFIX_PAGE_STATE, state);
        case 8:
          _context.next = 3;
          break;
        case 10:
...
var init = function init(widget, element, components, config, methods) {
  ...
  var initialPage = (0, _math.toInt)((_config$initialPage = config === null || config === void 0 ? void 0 : config.initialPage) !== null && _config$initialPage !== void 0 ? _config$initialPage : 1);
  ...
  if (isFullscreen) {
    viewWatcher = _viewWatcher3.ViewWatcher.reuse({
      rootMargin: "0px",
      threshold: 0.3
    });
  }
  if (useGestures) {
    gestureWatcher = _gestureWatcher3.GestureWatcher.reuse();
  }
...
var getMethods = function getMethods(widget, components, element, config) {
  ...
  var onTransition = function onTransition(handler) {
    return callbacks.add((0, _callback.wrapCallback)(handler));
  };
  return {
    _nextPage: nextPage,
    _prevPage: prevPage,
