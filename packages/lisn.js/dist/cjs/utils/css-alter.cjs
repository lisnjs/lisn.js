 ...
 */
var transitionElementNow = exports.transitionElementNow = function transitionElementNow(element, fromCls, toCls) {
 ...
 */
var transitionElement = exports.transitionElement = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return (0, _tasks.waitForDelay)(delay);
        case 5:
          _context.next = 7;
        ...
        case 15:
          ...
          _context.next = 19;
          return (0, _tasks.waitForDelay)(transitionDuration);
        case 19:
 ...
 * @category CSS: Altering
 */
var displayElementNow = exports.displayElementNow = function displayElementNow(element) {
 ...
 * @category CSS: Altering
 */
var undisplayElementNow = exports.undisplayElementNow = function undisplayElementNow(element) {
 ...
 * @category CSS: Altering (optimized)
 */
var undisplayElement = exports.undisplayElement = function undisplayElement(element) {
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
 ...
 * @category CSS: Altering
 */
var showElementNow = exports.showElementNow = function showElementNow(element) {
 ...
 * @category CSS: Altering
 */
var hideElementNow = exports.hideElementNow = function hideElementNow(element) {
 ...
 * @category CSS: Altering (optimized)
 */
var hideElement = exports.hideElement = function hideElement(element) {
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
 ...
 * @category CSS: Altering
 */
var toggleDisplayElementNow = exports.toggleDisplayElementNow = function toggleDisplayElementNow(element) {
 ...
 * @category CSS: Altering (optimized)
 */
var toggleDisplayElement = exports.toggleDisplayElement = function toggleDisplayElement(element) {
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
 ...
 * @category CSS: Altering
 */
var toggleShowElementNow = exports.toggleShowElementNow = function toggleShowElementNow(element) {
 ...
 * @category CSS: Altering (optimized)
 */
var toggleShowElement = exports.toggleShowElement = function toggleShowElement(element) {
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
 ...
 * @category CSS: Altering (optimized)
 */
var isElementHidden = exports.isElementHidden = function isElementHidden(element) {
 ...
 * @category CSS: Altering (optimized)
 */
var isElementUndisplayed = exports.isElementUndisplayed = function isElementUndisplayed(element) {
 ...
 * @category CSS: Altering
 */
var addClassesNow = exports.addClassesNow = function addClassesNow(el) {
  var _MH$classList;
 ...
 * @category CSS: Altering (optimized)
 */
var addClasses = exports.addClasses = function addClasses(el) {
 ...
 * @category CSS: Altering
 */
var removeClassesNow = exports.removeClassesNow = function removeClassesNow(el) {
  var _MH$classList2;
 ...
 * @category CSS: Altering (optimized)
 */
var removeClasses = exports.removeClasses = function removeClasses(el) {
 ...
 * @category CSS: Altering
 */
var toggleClassNow = exports.toggleClassNow = function toggleClassNow(el, className, force) {
 ...
 * @category CSS: Altering (optimized)
 */
var toggleClass = exports.toggleClass = function toggleClass(el, className, force) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @category CSS: Altering (optimized)
 */
var getData = exports.getData = function getData(el, name) {
 ...
 * @category CSS: Altering (optimized)
 */
var getBoolData = exports.getBoolData = function getBoolData(el, name) {
 ...
 * @category CSS: Altering
 */
var setDataNow = exports.setDataNow = function setDataNow(el, name, value) {
 ...
 * @category CSS: Altering (optimized)
 */
var setData = exports.setData = function setData(el, name, value) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @category CSS: Altering
 */
var setBoolDataNow = exports.setBoolDataNow = function setBoolDataNow(el, name) {
 ...
 * @category CSS: Altering (optimized)
 */
var setBoolData = exports.setBoolData = function setBoolData(el, name) {
  var value = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @category CSS: Altering
 */
var unsetBoolDataNow = exports.unsetBoolDataNow = function unsetBoolDataNow(el, name) {
 ...
 * @category CSS: Altering (optimized)
 */
var unsetBoolData = exports.unsetBoolData = function unsetBoolData(el, name) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @category CSS: Altering
 */
var delDataNow = exports.delDataNow = function delDataNow(el, name) {
 ...
 * @category CSS: Altering (optimized)
 */
var delData = exports.delData = function delData(el, name) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 */
var getComputedStylePropNow = exports.getComputedStylePropNow = function getComputedStylePropNow(element, prop) {
 ...
 */
var getComputedStyleProp = exports.getComputedStyleProp = function getComputedStyleProp(element, prop) {
  return (0, _domOptimize.waitForMeasureTime)().then(function () {
 ...
 * @category DOM: Altering
 */
var getStylePropNow = exports.getStylePropNow = function getStylePropNow(element, prop) {
  var _style;
 ...
 * @category DOM: Altering (optimized)
 */
var getStyleProp = exports.getStyleProp = function getStyleProp(element, prop) {
  return (0, _domOptimize.waitForMeasureTime)().then(function () {
 ...
 * @category DOM: Altering
 */
var setStylePropNow = exports.setStylePropNow = function setStylePropNow(element, prop, value) {
  var _style2;
 ...
 * @category DOM: Altering (optimized)
 */
var setStyleProp = exports.setStyleProp = function setStyleProp(element, prop, value) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @category DOM: Altering
 */
var delStylePropNow = exports.delStylePropNow = function delStylePropNow(element, prop) {
  var _style3;
 ...
 * @category DOM: Altering (optimized)
 */
var delStyleProp = exports.delStyleProp = function delStyleProp(element, prop) {
  return (0, _domOptimize.waitForMutateTime)().then(function () {
 ...
 * @internal
 */
var getMaxTransitionDuration = exports.getMaxTransitionDuration = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          return _context2.abrupt("return", MH.max.apply(MH, _toConsumableArray((0, _text.splitOn)(propVal, ",", true).map(function (strValue) {
 ...
 * @internal
 */
var disableInitialTransition = exports.disableInitialTransition = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(element) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          _context3.next = 8;
          return (0, _domOptimize.waitForSubsequentMutateTime)();
        case 8:
 ...
 * @internal
 */
var setHasModal = exports.setHasModal = function setHasModal() {
 ...
 * @internal
 */
var delHasModal = exports.delHasModal = function delHasModal() {
 ...
 * @internal
 */
var copyStyle = exports.copyStyle = /*#__PURE__*/function () {
 ...
 * @internal
 */
var setNumericStyleProps = exports.setNumericStyleProps = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          cssPropSuffix = (0, _text.camelToKebabCase)(prop);
