 ...
 */
var getEntryContentBox = exports.getEntryContentBox = function getEntryContentBox(entry) {
  var size = entry.contentBoxSize;
  if (size) {
    return getSizeFromInlineBlock(size);
  }
  var rect = entry.contentRect;
  return _defineProperty(_defineProperty({}, MC.S_WIDTH, rect[MC.S_WIDTH]), MC.S_HEIGHT, rect[MC.S_HEIGHT]);
};
 ...
 * @category Size measurements
 */
var getEntryBorderBox = exports.getEntryBorderBox = function getEntryBorderBox(entry) {
  ...
  return _defineProperty(_defineProperty({}, MC.S_WIDTH, NaN), MC.S_HEIGHT, NaN);
};
 ...
 * @category Validation
 */
var isValidBox = exports.isValidBox = function isValidBox(box) {
  return MH.includes(ALL_BOXES, box);
};
 ...
 * @category Validation
 */
var isValidDimension = exports.isValidDimension = function isValidDimension(dimension) {
  return MH.includes(ALL_DIMENSIONS, dimension);
};
 ...
 * @internal
 */
var tryGetViewportOverlay = exports.tryGetViewportOverlay = function tryGetViewportOverlay() {
 ...
 */
var fetchViewportOverlay = exports.fetchViewportOverlay = /*#__PURE__*/function () {
 ...
 * @internal
 */
var fetchViewportSize = exports.fetchViewportSize = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          root = MH.hasDOM() ? (_MH$getDocScrollingEl = MH.getDocScrollingElement()) !== null && _MH$getDocScrollingEl !== void 0 ? _MH$getDocScrollingEl : MH.getBody() : null;
          return _context2.abrupt("return", _defineProperty(_defineProperty({}, MC.S_WIDTH, (root === null || root === void 0 ? void 0 : root.clientWidth) || 0), MC.S_HEIGHT, (root === null || root === void 0 ? void 0 : root.clientHeight) || 0));
        case 6:
        case "end":
...
var ALL_DIMENSIONS = [MC.S_WIDTH, MC.S_HEIGHT];
var getSizeFromInlineBlock = function getSizeFromInlineBlock(size) {
  /* istanbul ignore else */
  if (MH.isIterableObject(size)) {
    return _defineProperty(_defineProperty({}, MC.S_WIDTH, size[0][S_INLINE_SIZE]), MC.S_HEIGHT, size[0][S_BLOCK_SIZE]);
  }
  return _defineProperty(_defineProperty({}, MC.S_WIDTH, size[S_INLINE_SIZE]), MC.S_HEIGHT, size[S_BLOCK_SIZE]);
};
...
var init = function init() {
  if (!initPromise) {
    initPromise = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
          ...
          case 0:
            ...
            return (0, _overlays.createOverlay)({
              ...
              style: _defineProperty(_defineProperty({
                position: "fixed"
              }, MC.S_WIDTH, "100vw"), MC.S_HEIGHT, "100vh")
            });
          case 2:
