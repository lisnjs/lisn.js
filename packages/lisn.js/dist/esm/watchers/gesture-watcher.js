 ...
 */
export var GestureWatcher = /*#__PURE__*/function () {
...
var fragmentGetters = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, MC.S_KEY, getKeyGestureFragment), MC.S_POINTER, getPointerGestureFragment), MC.S_TOUCH, getTouchGestureFragment), MC.S_WHEEL, getWheelGestureFragment);
var getOptions = function getOptions(config, options) {
  ...
  var debounceWindow = toNonNegNum(options[MC.S_DEBOUNCE_WINDOW], config._debounceWindow // watcher is never debounced, so apply default here
  );
