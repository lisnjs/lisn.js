 ...
 * @module Widgets
 */
var Widget = exports.Widget = /*#__PURE__*/function () {
  /**
  ...
  function Widget(element, config) {
    ...
    var logger = _debug["default"] ? new _debug["default"].Logger({
      name: "".concat(this.constructor.name, "-").concat((0, _text.formatAsString)(element)),
      logAtCreation: this
    }) : null;
    ...
    this.onDisable = function (handler) {
      return disableCallbacks.add((0, _callback.wrapCallback)(handler));
    };
    this.onEnable = function (handler) {
      return enableCallbacks.add((0, _callback.wrapCallback)(handler));
    };
    ...
    this.onDestroy = function (handler) {
      return destroyCallbacks.add((0, _callback.wrapCallback)(handler));
    };
 ...
 */
var registerWidget = exports.registerWidget = /*#__PURE__*/function () {
      ...
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          if (_settings.settings.autoWidgets) {
            domWatcher = _domWatcher.DOMWatcher.reuse();
                ...
                return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                  while (1) switch (_context5.prev = _context5.next) {
                    ...
                    case 8:
                      ...
                      widgets = [];
                      configSpecs = [];
                      dataAttr = (0, _cssAlter.getData)(element, prefixedName);
                      if (options !== null && options !== void 0 && options.supportsMultiple) {
                        if ((0, _cssAlter.hasClass)(element, prefixedName)) {
                          configSpecs.push("");
                        }
                        if (dataAttr !== null) {
                          configSpecs.push.apply(configSpecs, _toConsumableArray(dataAttr ? (0, _text.splitOn)(dataAttr, ";", true) : [""]));
                        }
                      } else {
                    ...
                    case 26:
                      ...
                      if (theseWidgets) {
                        widgets.push.apply(widgets, _toConsumableArray((0, _misc.toArrayIfSingle)(theseWidgets)));
                      }
                    case 28:
                      _i++;
                      _context5.next = 14;
 ...
 */
var getWidgetConfig = exports.getWidgetConfig = function getWidgetConfig(input, validator) {
 ...
 */
var fetchWidgetConfig = exports.fetchWidgetConfig = /*#__PURE__*/function () {
 ...
 * @internal
 */
var getDefaultWidgetSelector = exports.getDefaultWidgetSelector = function getDefaultWidgetSelector(prefix) {
 ...
 * @internal
 */
var fetchUniqueWidget = exports.fetchUniqueWidget = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          (0, _log.logWarn)("No ".concat(name, " widget for element ").concat((0, _text.formatAsString)(element)));
...
var instances = (0, _xMap.newXWeakMap)(function () {
  return MH.newMap();
});
...
var toOptionsObject = function toOptionsObject(input, separator) {
  var options = {};
  var _iterator5 = _createForOfIteratorHelper(MH.filter((0, _text.splitOn)(input !== null && input !== void 0 ? input : "", separator, true), function (v) {
      return !MH.isEmpty(v);
    })),
    _step5;
  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      ...
      var _splitOn = (0, _text.splitOn)(entry, /\s*=\s*/, true, 1),
        _splitOn2 = _slicedToArray(_splitOn, 2),
        _key3 = _splitOn2[0],
        value = _splitOn2[1];
      options[(0, _text.kebabToCamelCase)(_key3)] = value !== null && value !== void 0 ? value : "";
    }
  } catch (err) {
    _iterator5.e(err);
  } finally {
