...
import { validateStrList, validateBoolean, validateBooleanOrString, validateString } from "../utils/validation.js";
...
import { Widget, registerWidget, getWidgetConfig, getDefaultWidgetSelector } from "./widget.js";
 ...
 */
export var registerOpenable = function registerOpenable(name, newOpenable, configValidator) {
 ...
 */
export var Openable = /*#__PURE__*/function (_Widget) {
  function Openable(element, properties) {
    ...
    _this.onOpen = function (handler) {
      return openCallbacks.add(wrapCallback(handler));
    };
    _this.onClose = function (handler) {
      return closeCallbacks.add(wrapCallback(handler));
    };
 ...
 * ```
 */
export var Collapsible = /*#__PURE__*/function (_Openable2) {
      ...
      var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return removeClasses(root, MC.PREFIX_TRANSITION_DISABLE);
            case 2:
              _context4.next = 4;
              return removeClasses(wrapper, MC.PREFIX_TRANSITION_DISABLE);
            case 4:
        ...
        var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
          ...
          return _regeneratorRuntime().wrap(function _callee6$(_context6) {
            while (1) switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return getComputedStyleProp(root, MC.S_WIDTH);
              case 2:
 ...
 * ```
 */
export var Popup = /*#__PURE__*/function (_Openable3) {
      ...
      _this3.onOpen(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return MH.promiseAll([SizeWatcher.reuse().fetchCurrentSize(element), ViewWatcher.reuse().fetchCurrentView(container)]);
            case 2:
            ...
            case 8:
              ...
              _context8.next = 12;
              return setData(root, MC.PREFIX_PLACE, placement);
            case 12:
            case "end":
 ...
 * ```
 */
export var Modal = /*#__PURE__*/function (_Openable4) {
 ...
 * ```
 */
export var Offcanvas = /*#__PURE__*/function (_Openable5) {
  function Offcanvas(element, config) {
    ...
    setData(_this4.getRoot(), MC.PREFIX_PLACE, position);
    return _this4;
  }
...
var getTriggersFrom = function getTriggersFrom(content, inputTriggers, wrapTriggers, prefixedNames) {
  ...
  var addTrigger = function addTrigger(trigger, triggerConfig) {
    if (wrapTriggers) {
      var wrapper = MH.createElement(isInlineTag(MH.tagName(trigger)) ? "span" : "div");
      wrapElement(trigger, {
        wrapper: wrapper,
        ignoreMove: true
      }); // no need to await
...
var setupElements = function setupElements(widget, content, properties) {
  ...
  if (properties.closeButton) {
    ...
    addEventListenerTo(closeBtn, MC.S_CLICK, function () {
      widget.close();
    });
...
var setupListeners = function setupListeners(widget, elements, properties, prefixedNames) {
  ...
  var isTrigger = function isTrigger(element) {
    return MH.includes(MH.arrayFrom(triggers.keys()), element.closest(getDefaultWidgetSelector(prefixedNames._trigger)));
  };
