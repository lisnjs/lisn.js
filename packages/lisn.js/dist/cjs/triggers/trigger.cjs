 ...
 * @category Manual run
 */
var Trigger = exports.Trigger = /*#__PURE__*/function (_Widget) {
  /**
  ...
  function Trigger(element, actions, config) {
    ...
    var logger = _debug["default"] ? new _debug["default"].Logger({
      name: "Trigger-".concat((0, _text.formatAsString)(element)),
      logAtCreation: {
        actions: actions,
        config: config
      }
    ...
    var run = (0, _callback.wrapCallback)(function () {
      callActions(doDelay, function (action) {
        action["do"]();
      }, true); // don't await
    });
    var reverse = (0, _callback.wrapCallback)(function () {
      if (!oneWay) {
    ...
    var toggle = (0, _callback.wrapCallback)(function () {
 ...
 */
var registerTrigger = exports.registerTrigger = function registerTrigger(name, newTrigger, configValidator) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            allSpecs = (0, _text.splitOn)((_getData = (0, _cssAlter.getData)(element, MH.prefixName("on-".concat(name)))) !== null && _getData !== void 0 ? _getData : "", TRIGGER_SEP, true);
          ...
          case 16:
            ...
            spec = _step3.value;
            _splitOn = (0, _text.splitOn)(spec, OPTION_PREF_CHAR, true, 1), _splitOn2 = _slicedToArray(_splitOn, 2), tmp = _splitOn2[0], configSpec = _splitOn2[1];
            _splitOn3 = (0, _text.splitOn)(tmp, ACTION_PREF_CHAR, true, 1), _splitOn4 = _slicedToArray(_splitOn3, 2), argSpec = _splitOn4[0], allActionSpecs = _splitOn4[1];
            _args2 = MH.filterBlank((0, _text.splitOn)(argSpec, ",", true)) || [];
            _context2.next = 23;
            return (0, _widget.fetchWidgetConfig)(configSpec, MH.assign(baseConfigValidator, thisConfigValidator), OPTION_PREF_CHAR);
          case 23:
            _config = _context2.sent;
            actionTarget = (_config$actOn = _config.actOn) !== null && _config$actOn !== void 0 ? _config$actOn : element;
            _actions = [];
            _iterator4 = _createForOfIteratorHelper((0, _text.splitOn)(allActionSpecs || "", ACTION_PREF_CHAR, true));
            _context2.prev = 27;
            _iterator4.s();
          case 29:
            ...
            _splitOn5 = (0, _text.splitOn)(actionSpec, ACTION_ARGS_PREF_CHAR, true, 1), _splitOn6 = _slicedToArray(_splitOn5, 2), _name = _splitOn6[0], actionArgsAndOptions = _splitOn6[1];
            _context2.prev = 32;
            _context2.t1 = _actions;
            _context2.next = 36;
            return (0, _action.fetchAction)(actionTarget, _name, actionArgsAndOptions || "");
          case 36:
          ...
          case 40:
            ...
            if (!MH.isInstanceOf(_context2.t3, _errors.LisnUsageError)) {
              _context2.next = 44;
              break;
            }
...
var newBaseConfigValidator = function newBaseConfigValidator(element) {
  return {
    ...
    actOn: function actOn(key, value) {
      var _ref3;
      return (_ref3 = MH.isLiteralString(value) ? (0, _domSearch.waitForReferenceElement)(value, element) : null) !== null && _ref3 !== void 0 ? _ref3 : undefined;
    }
  };
};
