 ...
 */
var LisnError = exports.LisnError = /*#__PURE__*/function (_Error) {
  function LisnError() {
 ...
 */
var LisnUsageError = exports.LisnUsageError = /*#__PURE__*/function (_LisnError) {
  function LisnUsageError() {
    var _this;
    var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
    _classCallCheck(this, LisnUsageError);
    _this = _callSuper(this, LisnUsageError, ["".concat(_minificationConstants.LOG_PREFIX, " Incorrect usage: ").concat(message)]);
 ...
 */
var LisnBugError = exports.LisnBugError = /*#__PURE__*/function (_LisnError2) {
  function LisnBugError() {
    var _this2;
    var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
    _classCallCheck(this, LisnBugError);
    _this2 = _callSuper(this, LisnBugError, ["".concat(_minificationConstants.LOG_PREFIX, " Please report a bug: ").concat(message)]);
