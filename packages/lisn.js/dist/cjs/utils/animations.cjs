 ...
 * @category Animations
 */
var iterateAnimations = exports.iterateAnimations = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(element, webAnimationCallback, legacyCallback) {
    var realtime,
      _iterator,
      _step,
      animation,
 ...
 * @internal
 */
var resetCssAnimationsNow = exports.resetCssAnimationsNow = function resetCssAnimationsNow(element) {
