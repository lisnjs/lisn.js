...
export const ScrollbarComponent = _ref => {
  ...
  const elementRef = useWidget(newScrollbar, config, widgetRef);
...
export const useScrollbar = config => {
...
const newScrollbar = (element, config) => element instanceof HTMLElement ? new Scrollbar(element, config) : null;
