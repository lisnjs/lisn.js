...
const SortableComponent = _ref => {
  ...
  const elementRef = (0, _useWidget.useWidget)(newSortable, config, widgetRef);
  return (0, _react.createElement)(as || "div", _objectSpread({
    ref: elementRef
  }, props), children);
};
exports.SortableComponent = SortableComponent;
const SortableItemComponent = _ref2 => {
  let {
      as,
      children
    } = _ref2,
...
const newSortable = (element, config) => new _lisn.Sortable(element, Object.assign({}, config, {
