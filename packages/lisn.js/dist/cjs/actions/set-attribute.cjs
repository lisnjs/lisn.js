 ...
 */
var SetAttribute = exports.SetAttribute = /*#__PURE__*/function () {
  function SetAttribute(element, attributes) {
    ...
    var isOn = false;
    var setAttrs = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(on) {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              for (attr in attributes) {
                ...
                attrName = (0, _text.camelToKebabCase)(attr);
  ...
  return _createClass(SetAttribute, null, [{
    ...
    value: function register() {
      (0, _action.registerAction)("set-attribute", function (element, args, config) {
...
var configValidator = {
  on: _validation.validateString,
  off: _validation.validateString
};
//# sourceMappingURL=set-attribute.cjs.map