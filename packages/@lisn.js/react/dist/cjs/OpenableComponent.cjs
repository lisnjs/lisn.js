...
var CollapsibleComponent = exports.CollapsibleComponent = function CollapsibleComponent(_ref) {
...
var newCollapsible = function newCollapsible(element, config) {
  return element instanceof HTMLElement ? new _lisn.Collapsible(element, Object.assign({}, config, {
...
var PopupComponent = exports.PopupComponent = function PopupComponent(_ref2) {
...
var newPopup = function newPopup(element, config) {
  return element instanceof HTMLElement ? new _lisn.Popup(element, Object.assign({}, config, {
    triggers: (0, _util.getElementsFromRefs)(config === null || config === void 0 ? void 0 : config.triggers)
  })) : null;
};
...
var ModalComponent = exports.ModalComponent = function ModalComponent(_ref3) {
...
var newModal = function newModal(element, config) {
  return element instanceof HTMLElement ? new _lisn.Modal(element, Object.assign({}, config, {
    triggers: (0, _util.getElementsFromRefs)(config === null || config === void 0 ? void 0 : config.triggers)
  })) : null;
};
...
var OffcanvasComponent = exports.OffcanvasComponent = function OffcanvasComponent(_ref4) {
...
var newOffcanvas = function newOffcanvas(element, config) {
  return element instanceof HTMLElement ? new _lisn.Offcanvas(element, Object.assign({}, config, {
    triggers: (0, _util.getElementsFromRefs)(config === null || config === void 0 ? void 0 : config.triggers)
  })) : null;
};
...
var CollapsibleTriggerComponent = exports.CollapsibleTriggerComponent = function CollapsibleTriggerComponent(allProps) {
  return TriggerComponent(_objectSpread({
    name: "collapsible"
  }, allProps));
};
var PopupTriggerComponent = exports.PopupTriggerComponent = function PopupTriggerComponent(allProps) {
  return TriggerComponent(_objectSpread({
    name: "popup"
  }, allProps));
};
var ModalTriggerComponent = exports.ModalTriggerComponent = function ModalTriggerComponent(allProps) {
  return TriggerComponent(_objectSpread({
    name: "modal"
  }, allProps));
};
var OffcanvasTriggerComponent = exports.OffcanvasTriggerComponent = function OffcanvasTriggerComponent(allProps) {
  return TriggerComponent(_objectSpread({
    name: "offcanvas"
  }, allProps));
};
var TriggerComponent = function TriggerComponent(_ref5) {
  ...
  return (0, _react.createElement)(as || "div", _objectSpread(_objectSpread(_defineProperty({}, "data-lisn-".concat(name, "-trigger"), configStr), contentId ? _defineProperty({}, "data-lisn-".concat(name, "-content-id"), contentId) : {}), props), children);
};

// --------------------

var useOpenable = function useOpenable(newWidget, config, widgetRef) {
  var elementRef = (0, _useWidget.useWidget)(newWidget, config, widgetRef);
