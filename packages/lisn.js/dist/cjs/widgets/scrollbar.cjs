 ...
 * ```
 */
var Scrollbar = exports.Scrollbar = /*#__PURE__*/function (_Widget) {
  /**
  ...
  return _createClass(Scrollbar, null, [{
    ...
    value: function enableMain(config) {
      return _scrollWatcher.ScrollWatcher.fetchMainScrollableElement().then(function (main) {
...
var getScrollableProps = function getScrollableProps(containerElement) {
  ...
  var mainScrollableElement = (0, _scroll.tryGetMainScrollableElement)();
  var body = MH.getBody();
  var defaultScrollable = (0, _scroll.getDefaultScrollingElement)();
  ...
  var allowedToWrap = _settings.settings.contentWrappingAllowed && (0, _cssAlter.getData)(containerElement, MC.PREFIX_NO_WRAP) === null;
  var needsSticky = !isMainScrollable && !allowedToWrap;
  var barParent = isMainScrollable ? body : containerElement;
  var hasFixedHeight = (0, _scroll.isScrollable)(root, {
    axis: "y"
  });
...
var init = function init(widget, containerElement, props, config) {
  ...
  var logger = _debug["default"] ? new _debug["default"].Logger({
    name: "Scrollbar-".concat((0, _text.formatAsString)(root)),
    logAtCreation: {
      props: props,
      config: config
    }
  ...
  // config
  var onMobile = (_ref2 = (_config$onMobile = config === null || config === void 0 ? void 0 : config.onMobile) !== null && _config$onMobile !== void 0 ? _config$onMobile : _settings.settings.scrollbarOnMobile) !== null && _ref2 !== void 0 ? _ref2 : false;
  var hideNative = (_ref3 = (_config$hideNative = config === null || config === void 0 ? void 0 : config.hideNative) !== null && _config$hideNative !== void 0 ? _config$hideNative : _settings.settings.scrollbarHideNative) !== null && _ref3 !== void 0 ? _ref3 : false;
  var positionH = (config === null || config === void 0 ? void 0 : config.positionH) || _settings.settings.scrollbarPositionH;
  var positionV = (config === null || config === void 0 ? void 0 : config.positionV) || _settings.settings.scrollbarPositionV;
  var autoHideDelay = (_config$autoHide = config === null || config === void 0 ? void 0 : config.autoHide) !== null && _config$autoHide !== void 0 ? _config$autoHide : _settings.settings.scrollbarAutoHide;
  var clickScroll = (_config$clickScroll = config === null || config === void 0 ? void 0 : config.clickScroll) !== null && _config$clickScroll !== void 0 ? _config$clickScroll : _settings.settings.scrollbarClickScroll;
  var dragScroll = (_ref4 = (_config$dragScroll = config === null || config === void 0 ? void 0 : config.dragScroll) !== null && _config$dragScroll !== void 0 ? _config$dragScroll : _settings.settings.scrollbarDragScroll) !== null && _ref4 !== void 0 ? _ref4 : false;
  var useHandle = (_ref5 = (_config$useHandle = config === null || config === void 0 ? void 0 : config.useHandle) !== null && _config$useHandle !== void 0 ? _config$useHandle : _settings.settings.scrollbarUseHandle) !== null && _ref5 !== void 0 ? _ref5 : false;
  ...
  var updateProgress = function updateProgress(target, scrollData) {
    ...
    if (autoHideDelay > 0) {
      (0, _cssAlter.showElement)(wrapper).then(function () {
        return (0, _cssAlter.hideElement)(wrapper, autoHideDelay);
      });
    }
  };
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            isHandleClick = isClick && useHandle && (0, _cssAlter.hasClass)(target, PREFIX_HANDLE);
          ...
          case 16:
            ...
            maxScrollOffset = tracksH ? scrollable[MC.S_SCROLL_WIDTH] - (0, _scroll.getClientWidthNow)(scrollable) : scrollable[MC.S_SCROLL_HEIGHT] - (0, _scroll.getClientHeightNow)(scrollable); // Get click offset relative to the scrollbar regardless of what the
          ...
          case 25:
            ...
            if (!isClick && useHandle) {
              // Dragging the handle
              handleLength = handle ? MH.parseFloat((0, _cssAlter.getComputedStylePropNow)(handle, barIsHorizontal ? MC.S_WIDTH : MC.S_HEIGHT)) : 0;
  ...
  if (config !== null && config !== void 0 && config.className) {
    _cssAlter.addClasses.apply(void 0, [scrollable].concat(_toConsumableArray((0, _misc.toArrayIfSingle)(config.className))));
  }
  var scrollDomID =
  // for ARIA
  clickScroll || dragScroll ? (0, _domAlter.getOrAssignID)(scrollable, S_SCROLLBAR) : "";
  var scrollWatcher = _scrollWatcher.ScrollWatcher.reuse(_defineProperty({}, MC.S_DEBOUNCE_WINDOW, 0));
  var sizeWatcher = _sizeWatcher.SizeWatcher.reuse(_defineProperty({}, MC.S_DEBOUNCE_WINDOW, 0));
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          for (_i = 0, _arr = [MC.S_TOP, MC.S_BOTTOM, MC.S_LEFT, MC.S_RIGHT]; _i < _arr.length; _i++) {
            position = _arr[_i];
            (0, _cssAlter.delDataNow)(containerElement, "".concat(PREFIX_HAS_SCROLLBAR, "-").concat(position));
          }
...
var isHorizontal = function isHorizontal(scrollbar) {
  return (0, _cssAlter.getData)(scrollbar, MC.PREFIX_ORIENTATION) === MC.S_HORIZONTAL;
};
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          ...
          key = _arr3[_i3];
          _context5.next = 8;
          return (0, _cssAlter.getComputedStyleProp)(element, key);
        case 8:
