 ...
 * @category Logging
 */
var RemoteConsole = exports.RemoteConsole = /*#__PURE__*/function () {
  /**
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            sendLog = function sendLog(level, args) {
              if (!hasFailed) {
                ioClient.emit("console.".concat(level), _text.joinAsString.apply(void 0, [" "].concat(_toConsumableArray(args))));
              }
            };
