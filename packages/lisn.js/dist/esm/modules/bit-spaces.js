 ...
 */
export var BitSpaces = /*#__PURE__*/_createClass(function BitSpaces() {
 ...
 * @internal
 */
export var newBitSpaces = function newBitSpaces() {
 ...
 * @internal
 */
export var createBitSpace = function createBitSpace(spaces) {
...
var newBitSpace = function newBitSpace(counter, propNames) {
  ...
  var bitmask = getBitmask(start, end);
  var space = {
    bit: {},
    start: start,
    end: end,
