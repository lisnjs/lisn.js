...
import { scheduleHighPriorityTask } from "./tasks.js";
 ...
 */
export var waitForMutateTime = function waitForMutateTime() {
 ...
 * @category DOM: Preventing layout trashing
 */
export var waitForMeasureTime = function waitForMeasureTime() {
  return MH.newPromise(function (resolve) {
 ...
 * @category DOM: Preventing layout trashing
 */
export var waitForSubsequentMutateTime = function waitForSubsequentMutateTime() {
 ...
 * @category DOM: Preventing layout trashing
 */
export var waitForSubsequentMeasureTime = function waitForSubsequentMeasureTime() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          scheduleHighPriorityTask(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
//# sourceMappingURL=dom-optimize.js.map