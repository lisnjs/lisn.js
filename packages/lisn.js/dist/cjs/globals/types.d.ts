 ...
 * @category Layout
 */
export type LayoutSpec<L extends Layout> = CommaSeparatedStr<L> | `max ${L}` | `min ${L}` | RangeStr<" to ", L>;
/**
 * @category Layout
 */
 ...
 * @category Directions
 */
export type Direction = XYDirection | ZDirection | NoDirection | AmbiguousDirection;
/**
 ...
 * @category Misc
 */
export type Point = [ /** x position *//** x position */ number, /** y position */ number];
/**
 ...
 * @category Utility
 */
export type NonNullableReturnType<F extends (...args: unknown[]) => unknown> = NonNullable<ReturnType<F>>;
/**
 * @category Utility
 */
 ...
 * @category Utility
 */
export type SeparatedStr<S extends string, T extends string, Key extends T = T> = Key extends string ? `${Key},${SeparatedStr<S, Exclude<T, Key>>}` | Key : never;
/**
 * @category Utility
 */
export type CommaSeparatedStr<T extends string, Key extends T = T> = SeparatedStr<",", T, Key>;
/**
 * @category Utility
 */
export type RangeStr<S extends string, T extends string, Key extends T = T> = Key extends string ? `${Key}${S}${Exclude<T, Key>}` : never;
/**
 * @category Utility
 */
