...
exports.wrapCallback = exports.Callback = void 0;
 ...
 * @internal
 */
var _wrapCallback = exports.wrapCallback = function wrapCallback(handlerOrCallback) {
  ...
  var wrapper = new Callback((0, _tasks.getDebouncedHandler)(debounceWindow, function () {
    if (!isRemoved()) {
 ...
 */
var Callback = exports.Callback = /*#__PURE__*/_createClass(
/**
