 ...
 * @category Overlays
 */
var getOverlay = exports.getOverlay = function getOverlay(userOptions) {
  var _overlays$get;
 ...
 * @category Overlays
 */
var createOverlay = exports.createOverlay = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(userOptions) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          isPercentageHOffset = MH.includes((options._style.left || "") + (options._style.right || ""), "%");
          isPercentageVOffset = MH.includes((options._style.top || "") + (options._style.bottom || ""), "%");
          ...
          _context.next = 22;
          return (0, _domAlter.wrapScrollingContent)(parentEl);
        case 22:
        ...
        case 26:
          ...
          _context.next = 29;
          return (0, _domAlter.moveElement)(overlay, {
            to: parentEl
          });
        case 29:
...
var overlays = (0, _xMap.newXWeakMap)(function () {
  return MH.newMap();
});
...
var fetchOverlayOptions = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userOptions) {
...
var getOverlayKey = function getOverlayKey(style, data) {
  return (0, _text.objToStrKey)(style) + "|" + (0, _text.objToStrKey)(data);
};
var getCssProperties = function getCssProperties(style) {
  var finalCssProperties = MH.merge({
...
var tryGetParent = function tryGetParent(userSuppliedParent, position) {
  return userSuppliedParent !== null && userSuppliedParent !== void 0 ? userSuppliedParent : position === MC.S_FIXED ? MH.getBody() : (0, _scroll.tryGetMainContentElement)();
};
var fetchParent = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(userSuppliedParent, position) {
...
var createOnlyOverlay = function createOnlyOverlay(options) {
  ...
  var _iterator = _createForOfIteratorHelper(MH.keysOf(data)),
    _step;
  try {
  ...
  var _iterator2 = _createForOfIteratorHelper(MH.keysOf(style)),
    _step2;
  try {
