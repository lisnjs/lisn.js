 ...
 * and hold or hover.
 */
export var PointerWatcher = /*#__PURE__*/function () {
...
var setupClickListener = function setupClickListener(target, startCallback, endCallback, options) {
  ...
  var remove = function remove() {
    return removeEventListenerFrom(target, MC.S_CLICK, wrapper);
  };
...
var invokeCallback = function invokeCallback(callback, target, actionData, event) {
  return callback.invoke(target, MH.copyObject(actionData), event)["catch"](logError);
};
