 ...
 * @category View
 */
var ViewTrigger = exports.ViewTrigger = /*#__PURE__*/function (_Trigger) {
  /**
  ...
  function ViewTrigger(element, actions, config) {
    ...
    var logger = _debug["default"] ? new _debug["default"].Logger({
      name: "ViewTrigger-".concat((0, _text.formatAsString)(element))
    }) : null;
    ...
    var watcher = _viewWatcher.ViewWatcher.reuse({
    ...
    var oppositeViews = (0, _views.getOppositeViews)(views);
  ...
  return _createClass(ViewTrigger, null, [{
    ...
    value: function register() {
      (0, _trigger.registerTrigger)("view", function (element, args, actions, config) {
...
var newConfigValidator = function newConfigValidator(element) {
  return {
    ...
    threshold: function threshold(key, value) {
      return (0, _validation.validateNumList)(key, value);
    }
  };
};
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(element) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          allowedToWrap = _settings.settings.contentWrappingAllowed === true && (0, _cssAlter.getData)(element, MC.PREFIX_NO_WRAP) === null &&
          ...
          _context.next = 4;
          return (0, _domAlter.wrapElement)(element, {
            ignoreMove: true
          });
        case 4:
        ...
        case 15:
          _context.next = 17;
          return (0, _domAlter.insertGhostClone)(element);
        case 17:
